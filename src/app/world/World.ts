...
export class World {
    ...
    private _minCreatureCount:number = 300;
    private _maxCreatureCount:number = 500;
    ...
    public set maxCreatureCount (value:number) {
        this._maxCreatureCount = Math.max(this.minCreatureCount, value);
    }

    public get maxCreatureCount (){
        return this._maxCreatureCount;
    }

    public set minCreatureCount (value:number) {
        this._minCreatureCount = Math.min(this.maxCreatureCount, value);
    }

    public get minCreatureCount (){
        return this._minCreatureCount;
    }
    ...
    public addCreature (creature:Creature):void {
        if(this.aliveCreaturesCount < this.maxCreatureCount){
    ...
    public setCreatureCountTo (n:number):void {
        ...
        n = Math.min (n, this.maxCreatureCount);
